...
- **FR-018**: Resources MUST support structured classification metadata covering at minimum criticality, data sensitivity, compliance scope, availability tier, business domain, and operational tier.
