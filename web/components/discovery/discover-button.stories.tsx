...
function StoryShell({ hasRole, coalesce, failClick }: StoryArgs) {
  // Patch module-level hooks via dynamic require — Storybook runs CSR so we
  // can mutate globalThis to deliver mock impls. For simple visual stories
  // this is enough; the Vitest tests cover the wiring details.
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  const w = window as any;
  w.__BT_DISCOVERY_MOCK__ = { hasRole, coalesce, failClick };
